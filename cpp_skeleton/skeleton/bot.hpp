...
class Bot
{
    public:
         ...
         */
        virtual void handle_new_round(GameState* game_state, RoundState* round_state, int active);
         ...
         * @param active Your player's index.
         */
        virtual void handle_round_over(GameState* game_state, TerminalState* terminal_state, int active);
         ...
         * @return Your action.
         */
        virtual Action get_action(GameState* game_state, RoundState* round_state, int active);
};
